...
import { createCompiler, isCapabilityType, read_file, read_line, OPS, COMPILER_MODULES, isCompilerModule, CLOSURE_OPS, isClosureOpcode, isFunctionType, oplen } from './compiler_core.mjs';
...
eq('oplen recognizes closure opcodes MKCLOSURE and CALLCLOSURE', oplen(73) === 2 && oplen(74) === 1, true);
